    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        ...
        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
          <router-link :to="{ name: 'SignIn' }" v-if="!isAuthenticated" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900"> 
            Sign in 
          </router-link>
          <router-link :to="{ name: 'SignUp' }" v-if="!isAuthenticated" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> 
            Sign up 
          </router-link>
          <NavbarProfileDropdown v-if="isAuthenticated"/>
        </div>
      </div>
    </div>
        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          ...
          <div class="py-6 px-5 space-y-6">
            ...
            <div v-if="!isAuthenticated">
              <router-link :to="{ name: 'SignUp' }" class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> 
                Sign up 
              </router-link>
              <p class="mt-6 text-center text-base font-medium text-gray-500">
                Existing customer?
                {{ ' ' }}
                <router-link :to="{ name: 'SignIn' }" class="text-indigo-600 hover:text-indigo-500"> 
                  Sign in 
                </router-link>
              </p>
            </div>
